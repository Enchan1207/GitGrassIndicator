...
class SwifterClient {
    private (set) public var swifter: Swifter
    ...
    // ユーザオブジェクト取得
    func showUser(userTag: UserTag, completion: @escaping (_ response: JSON?) -> Void){
    ...
    // ユーザアイコン更新
    func updateProfileImage(imageData: Data, completion: @escaping (_ response: JSON) -> Void){
